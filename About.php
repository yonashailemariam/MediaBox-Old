			...
			<ul>
				...
				<li>
					<a href="SecurityDetails.php">
						<span class="visible-sm visible-md visible-lg" ><i class="fa fa-lock fa-2x"></i> Security Details
	...
	<div class="container body-content">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse target">
						<ul class="nav navbar-nav">
							...
							<li><a href="#" style="color: black; font-size: larger;"><i class="fa fa-sitemap fa-2x"></i> About</a></li>
						</ul>
		...
		<div class="col-xs-12 col-md-6">
			<div class="page-header">
				<h3><span class="label label-info" style="padding-top: 1em;"><i class="fa fa-sitemap fa-2x"></i> About MediaBox Site</span></h3>
				<h5 class="text-muted"><span class="label label-default">Site Description</span></h5>
			</div>
			<div class="jumbotron" id="Frontjumbotron">
				<div id="accordion">
					<h2 id="AccordionHeader">Content</h2>
					<div id="AccordionBody">
						<p></p>
					</div>
					<h2 id="AccordionHeader">Map</h2>
					<div id="AccordionBody">
						<p></p>
					</div>
				</div>

	...
	<div class="col-md-2">
		...
		<nav id="LeftSideNav" class="Left-Navigation">
			<ul>
				...
				<li>
					<a href="VideoBox.php">
						<span class="visible-sm visible-md visible-lg" style="font-size: larger; color:white;"><i class="fa fa-video-camera fa-2x"></i> Video Box
						<i class="fa fa-caret-left fa-2x" id="VideoBoxCaret"></i></span>
						<i class="fa fa-video-camera visible-xs" style="color: white;"></i>
					</a>
				</li>
		...
		<div class="col-xs-12 col-md-6">
			<div class="container visible-xs">
				...
				<div class="jumbotron" id="SmallFrontjumbotron">
					<div class="page-header">
						<h3><span class="label label-warning">Video Gallery</span></h3>
			...
			<div class="container visible-lg visible-md visible-sm">
				...
				<div class="alert alert-info alert-dismissible text-center" id="UploadAlert">
					<button id="CloseVideoUploadAlert" type="button" class="close">
				...
				<div class="jumbotron" id="Frontjumbotron">
					<div class="page-header">
						<h3><span class="label label-danger" style="padding-top: 1em;"><i class="fa fa-video-camera fa-2x"></i> Gallery</span></h3>
						<span class="label label-default">Here are Your Videos</span>
					</div>
				</div>
			</div>
		</div>

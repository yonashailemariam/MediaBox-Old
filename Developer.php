			...
			<ul>
				...
				<li>
					<a href="Developer.php">
						<span class="visible-sm visible-md visible-lg" style="font-size: larger; color:white;"><i class="fa fa-code fa-2x"></i> Developer
						<i class="fa fa-caret-left fa-2x" id="DeveloperCaret"></i></span>
						<i class="fa fa-code visible-xs" style="color: white;"></i>
					</a>
				</li>
	...
	<div class="container body-content">
		...
		<div class="col-xs-12 col-md-6">
			<div class="page-header">
				<h3><span class="label label-primary" style="padding-top: 1em;"><i class="fa fa-codepen fa-2x"></i> System Developer</span></h3>
				<h5 class="text-muted"><span class="label label-info">Info</span></h5>
			</div>
